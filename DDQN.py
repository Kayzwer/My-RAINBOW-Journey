...
class Agent:
    def __init__(self, input_dim: np.ndarray, output_dim: np.ndarray, learning_rate: float, gamma: float, tau: float, buffer_size: int, batch_size: int, epsilon: float, epsilon_decay_rate: str, minimum_epsilon: float, reward_target: float, reward_target_grow_rate: float, confidence: int) -> None:
